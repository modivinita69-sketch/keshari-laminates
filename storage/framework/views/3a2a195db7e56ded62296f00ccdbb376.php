...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Keshari Laminates - Premium Quality Laminates'); ?></title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('products*') ? 'active' : ''); ?>" href="<?php echo e(route('products')); ?>">Products</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('products')); ?>?category=solid">Plain/Solid Laminates</a></li>
                        <li><a href="<?php echo e(route('products')); ?>?category=wooden">Wooden Laminates</a></li>
                        <li><a href="<?php echo e(route('products')); ?>?category=abstract">Abstract Laminates</a></li>
                        <li><a href="<?php echo e(route('products')); ?>?category=decor">Decor Plys</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 mb-4">
                    <h5>Contact Info</h5>
...
</html><?php /**PATH D:\xampp\htdocs\keshari\resources\views/layouts/app.blade.php ENDPATH**/ ?>